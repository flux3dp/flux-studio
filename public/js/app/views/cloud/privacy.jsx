        ...
        return (
            <div className="cloud privacy">
                <div className="container">
                    <h2>Welcome to the FLUX Privacy Policy</h2>

                    <p>This privacy policy has been compiled to better serve those who are concerned with how their 'Personally Identifiable Information' (PII) is being used online. PII, as described in US privacy law and information security, is information that can be used on its own or with other information to identify, contact, or locate a single person, or to identify an individual in context. Please read our privacy policy carefully to get a clear understanding of how we collect, use, protect or otherwise handle your Personally Identifiable Information in accordance with our website.</p>

                    <h3>What personal information do we collect from the people that visit our website, software or app?</h3>
                    ...
                    <p>When you use FLUX Studio, we may collect anonymous usage data to improve the product quality. </p>

                    <p>When you use FLUX Cloud, we may collect the associations of your email and the serial number of your devices, status and usage data of your FLUX devices, and gain access to the camera on your FLUX devices, however, we will not store any image or video data. </p>

                    <h3>When do we collect information?</h3>

                    <p>We collect information from you when you register on our site, place an order, subscribe to a newsletter, respond to a survey, open a support ticket, sign in FLUX Cloud, use FLUX Studio or enter information on our site.</p>
                    ...
                    <pre><code>  - Help remember and process the items in the shopping cart.
                    ...
                    <p>However, you will still be able to place orders
                        Shopping cart, Member system
                    by contacting customer service.</p>
                    ...
                    <a href="mailto:info@flux3dp.com">info@flux3dp.com</a> and we will promptly remove you from ALL correspondence.</p>
                    ...
                    <p>Flux Inc.
                        10F-2, No.125, Section 2., Keelung Rd., Taipei 110, Taiwan
                    <a href="mailto:support@flux3dp.com">support@flux3dp.com</a></p>
                ...
                <div className="footer">
                    ...
                    <div className="actions">
                        <button className="btn btn-cancel" onClick={_handleBack}>{LANG.back}</button>
                    </div>
                </div>
