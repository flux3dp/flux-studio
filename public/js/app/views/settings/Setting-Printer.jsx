                ...
                render : function() {
                        ...
                        <div className="row-fluid set-password">
                            ...
                            <div className="password">
                                <table>
                                    <tr>
                                        <td>
                                            <button className="btn btn-default font3" data-ga-event="display-password-form" onClick={this._handleDisplayPasswordSection}>{lang.settings.printer.set_password}</button></td>
                                        <td>
                    ...
                    passwordSection = (
                        <div className="reset-password">
                            ...
                            <div className="row-fluid">
                                <div className="">
                                    <button className="btn btn-default" data-ga-event="save-password" onClick={this._handleSetPassword}>{lang.settings.printer.save_password}</button>
                                </div>
                            </div>
                        </div>
                    );
                    ...
                    wifiSection = (
                        <div className="row-fluid wifi">
                            ...
                            <div>
                                ...
                                <div>
                                    <button data-ga-event="join-other-network" className="btn btn-default">{lang.settings.printer.join_other_network}</button>
                                </div>
                            </div>
                        </div>
                    );
