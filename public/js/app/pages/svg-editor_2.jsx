...
//    'svgEdit/js-hotkeys/jquery.hotkeys.min',
//    'svgEdit/jquerybbq/jquery.bbq.min',
//    'svgEdit/svgicons/jquery.svgicons',
//    'svgEdit/jgraduate/jquery.jgraduate.min',
//    'svgEdit/spinbtn/JQuerySpinBtn.min',
//    'svgEdit/touch',
//
//    'svgEdit/svgedit.compiled',
//
//    'svgEdit/jquery-ui/jquery-ui-1.8.17.custom.min',
//    'svgEdit/jgraduate/jpicker',

    'css!svgEdit/svg-editor',
    'css!svgEdit/jgraduate/css/jPicker.css',
    'css!svgEdit/jgraduate/css/jgraduate.css',
    'css!svgEdit/spinbtn/JQuerySpinBtn.css',
    'css!svgEdit/custom.css'
...
<!--{endif}-->\
\
<script src="js/lib/svg-edit/js-hotkeys/jquery.hotkeys.min.js"></script>\
<script src="js/lib/svg-edit/jquerybbq/jquery.bbq.min.js"></script>\
<script src="js/lib/svg-edit/svgicons/jquery.svgicons.js"></script>\
<script src="js/lib/svg-edit/jgraduate/jquery.jgraduate.min.js"></script>\
<script src="js/lib/svg-edit/spinbtn/JQuerySpinBtn.min.js"></script>\
<script src="js/lib/svg-edit/touch.js"></script>\
\
<!--{if svg_edit_release}-->\
  <script src="js/lib/svg-edit/svgedit.compiled.js"></script>\
\
<!-- always minified scripts -->\
<script src="js/lib/svg-edit/jquery-ui/jquery-ui-1.8.17.custom.min.js"></script>\
<script src="js/lib/svg-edit/jgraduate/jpicker.js"></script>\
\
...
\
	<div id="circle_panel">\
		<div class="toolset">\
			...
			<input id="circle_cx" class="attr_changer" title="Change circles cx coordinate" size="3" data-attr="cx"/>\
			</label>\
			<label id="tool_circle_cy">cy:\
			<input id="circle_cy" class="attr_changer" title="Change circles cy coordinate" size="3" data-attr="cy"/>\
			</label>\
		</div>\
		<div class="toolset">\
			<label id="tool_circle_r">r:\
			<input id="circle_r" class="attr_changer" title="Change circles radius" size="3" data-attr="r"/>\
			</label>\
		</div>\
	</div>\
\
	<div id="ellipse_panel">\
		<div class="toolset">\
			...
			<input id="ellipse_cx" class="attr_changer" title="Change ellipses cx coordinate" size="3" data-attr="cx"/>\
			</label>\
			<label id="tool_ellipse_cy">cy:\
			<input id="ellipse_cy" class="attr_changer" title="Change ellipses cy coordinate" size="3" data-attr="cy"/>\
			</label>\
		</div>\
		<div class="toolset">\
			<label id="tool_ellipse_rx">rx:\
			<input id="ellipse_rx" class="attr_changer" title="Change ellipses x radius" size="3" data-attr="rx"/>\
			</label>\
			<label id="tool_ellipse_ry">ry:\
			<input id="ellipse_ry" class="attr_changer" title="Change ellipses y radius" size="3" data-attr="ry"/>\
			</label>\
		</div>\
	</div>\
\
	<div id="line_panel">\
		<div class="toolset">\
			...
			<input id="line_x1" class="attr_changer" title="Change lines starting x coordinate" size="3" data-attr="x1"/>\
			</label>\
			<label id="tool_line_y1">y1:\
			<input id="line_y1" class="attr_changer" title="Change lines starting y coordinate" size="3" data-attr="y1"/>\
			</label>\
		</div>\
		<div class="toolset">\
			<label id="tool_line_x2">x2:\
			<input id="line_x2" class="attr_changer" title="Change lines ending x coordinate" size="3" data-attr="x2"/>\
			</label>\
			<label id="tool_line_y2">y2:\
			<input id="line_y2" class="attr_changer" title="Change lines ending y coordinate" size="3" data-attr="y2"/>\
			</label>\
		</div>\
	</div>\
\
...
\
	<div id="path_node_panel">\
		...
		<label id="tool_node_x">x:\
			<input id="path_node_x" class="attr_changer" title="Change nodes x coordinate" size="3" data-attr="x"/>\
		</label>\
		<label id="tool_node_y">y:\
			<input id="path_node_y" class="attr_changer" title="Change nodes y coordinate" size="3" data-attr="y"/>\
		</label>\
\
