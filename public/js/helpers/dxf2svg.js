(function (f) {
    ...
    window.escapeUnicodeStr = function(value) {
        var unicodeChrs = value.match(/_U\+[0-9abcdef]{1,5}/ig);
        for (var i in unicodeChrs) {
            var chrString = unicodeChrs[i];
            value = value.replace(chrString, String.fromCharCode(parseInt(chrString.substring(3),16)));
        }
        return value;
    };
})(function () {
    ...
    return (function e(t, n, r) {
        ...
        4: [function (require, module, exports) {
            ...
            "./util/createArcForLWPolyline": 26,
            "./util/logger": 27,
            "b-spline": 28
        }],
        ...
        24: [function (require, module, exports) {
            ...
            var polylineToPath = function polylineToPath(rgb, polyline) {
                ...
                return '<path fill="none" stroke="' + hex + '" stroke-width="2" d="' + d + '"/>';
            };
            ...
            exports.default = function (parsed) {
                ...
                polylines.forEach(function (polyline, i) {
                    ...
                    var p2 = polyline.map(function (p) {
                        return [(p[0] - bbox.minX)*2.8346047, (bbox.maxY - p[1])*2.8346047];
                    });
                    if (!paths[entity.layer]) { paths[entity.layer] = []; }
                    paths[entity.layer].push(polylineToPath(rgb, p2));
                });

                var svgPaths = '';

                for (var i in paths) {
                    svgPaths += '<g id="' + i + '">' + paths[i].join('') + '</g>';
                }
                ...
                svgString += ' width="' + (bbox.width - bbox.minX + 3) + 'px" height="'  + (bbox.height - bbox.minY + 3) +  'px">' + svgPaths + '</svg>';
        ...
        32: [function (require, module, exports) {
            ...
            "lodash._getnative": 38,
            "lodash.isarguments": 40,
            "lodash.isarray": 41
        }],
        ...
        39: [function (require, module, exports) {
            ...
            "lodash._baseclone": 33,
            "lodash._bindcallback": 37
        }],
