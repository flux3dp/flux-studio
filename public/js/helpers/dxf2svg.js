(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.dxf = f()}})(function(){var define,module,exports;return (function(){function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s}return e})()({1:[function(require,module,exports){
    'use strict';
    ...
    },{"./util/logger":27,"lodash.clonedeep":37}],4:[function(require,module,exports){
    'use strict';
    ...
    var polylineToPath = function polylineToPath(rgb, polyline) {
      ...
      return `<path fill="transparent" stroke="#000" stroke-width="0.5px" d="${d}"/>`;
    };
    ...
    },{"lodash._basecopy":33,"lodash.keys":40}],32:[function(require,module,exports){
    (function (global){
    /**
    ...
    },{"lodash._arraycopy":29,"lodash._arrayeach":30,"lodash._baseassign":31,"lodash._basefor":34,"lodash.isarray":39,"lodash.keys":40}],33:[function(require,module,exports){
    /**
    ...
    },{"lodash._baseclone":32,"lodash._bindcallback":35}],38:[function(require,module,exports){
    /**
    ...
    },{"lodash._getnative":36,"lodash.isarguments":38,"lodash.isarray":39}],41:[function(require,module,exports){
    /**
    ...
    */
    ...
    },{"./V2":48}],43:[function(require,module,exports){
    "use strict";
    ...
    },{"./V2":48}],45:[function(require,module,exports){
    'use strict';
    ...
    },{"./V3":49}],46:[function(require,module,exports){
    'use strict';
    ...
    },{"./Box2":42,"./Box3":43,"./Line2":44,"./Line3":45,"./Plane3":46,"./Quaternion":47,"./V2":48,"./V3":49}]},{},[23])(23)
    });
