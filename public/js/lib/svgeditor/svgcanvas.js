...
function getAttr(element, attrs) {
	var obj = {};
...
//							call('selected', [selected]);
			...
			case 'fhpath':
				...
				break;
			case 'line':
				attrs = getAttr(element, ['x1', 'x2', 'y1', 'y2']);
			...
			case 'rect':
			case 'image':
				attrs = getAttr(element, ['width', 'height']);
...
this.svgCanvasToString = function() {
	...
	$(svgcontent).find('g').each(function() {
